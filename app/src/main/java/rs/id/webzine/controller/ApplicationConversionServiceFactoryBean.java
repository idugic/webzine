...
import rs.id.webzine.entity.magazine.ArticleBookmark;
import rs.id.webzine.entity.magazine.ArticleCategory;
import rs.id.webzine.entity.magazine.ArticleComment;
import rs.id.webzine.entity.magazine.ArticleCommentStatus;
import rs.id.webzine.entity.magazine.ArticleRate;
import rs.id.webzine.entity.magazine.ArticleStatus;
import rs.id.webzine.entity.magazine.Category;
import rs.id.webzine.entity.magazine.ReaderType;
