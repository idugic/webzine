...
// TODO make not related to entity and it's service
public class DesignController extends WebController {
  private static final Log log = LogFactory.getLog(DesignController.class);
  ...
  public DesignController(String path) {
    this.path = path;
  }
