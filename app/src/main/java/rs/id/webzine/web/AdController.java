...
public class AdController extends WebController {
  ...
  public String create(Ad ad, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    try {
      ...
      uiModel.asMap().clear();
      ad.persist();
      return "redirect:/admin/ad/" + encodeUrlPathSegment(ad.getId().toString(), httpServletRequest);
    } catch (Exception e) {
      log.error(e);
  ...
  void addDateTimeFormatPatterns(Model uiModel) {
    uiModel.addAttribute("date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
  }
  ...
  void populateEditForm(Model uiModel, Ad ad) {
    ...
    uiModel.addAttribute("customerList", Customer.findAll());
    uiModel.addAttribute("adStatusList", AdStatus.findAll());
    uiModel.addAttribute("availableArticleList", Article.findAvailableForAd(ad.getId()));
  ...
  public String createAdArticle(@PathVariable("adId") Integer adId, AdArticle adArticle, BindingResult bindingResult,
    ...
    uiModel.asMap().clear();
    return "redirect:/admin/ad/" + encodeUrlPathSegment(adId.toString(), httpServletRequest);
  }

  @RequestMapping(value = "/article/{adId}/{id}", method = RequestMethod.DELETE, produces = "text/html")
  public String deleteAdArticle(@PathVariable("adId") Integer adId, @PathVariable("id") Integer id, Model uiModel) {
  ...
  @RequestMapping(value = "/managed_content/{adId}", method = RequestMethod.PUT, produces = "text/html")
  public String updateManagedContent(@PathVariable("adId") Integer adId, ManagedContent managedContent,
  ...
  @RequestMapping(value = "/content/{adId}", method = RequestMethod.POST, produces = "text/html")
  public String createContent(@PathVariable("adId") Integer adId, Content content,
  ...
  @RequestMapping(value = "/content/{adId}/{id}", method = RequestMethod.DELETE, produces = "text/html")
  public String deleteContent(@PathVariable("adId") Integer adId, @PathVariable("id") Integer id, Model uiModel) {
