...
public class ArticleController extends WebController {
  ...
  // public String create(Article article, @RequestParam("abstractMedia")
  // MultipartFile abstractMedia,
  ...
  // return this.update(article, abstractMedia, bindingResult, uiModel,
  // httpServletRequest);
  // }
  //
  ...
  // String mediaUrl = httpServletRequest.getContextPath() +
  // "/admin/article/abstractMedia/"
  ...
  // uiModel.addAttribute("articleCategoryList",
  // ArticleCategory.findForArticle(article.getId()));
  // uiModel.addAttribute("articleCommentList",
  // ArticleComment.findForArticle(article.getId()));
  // uiModel.addAttribute("managedContent", article.getManagedContentId());
  // uiModel.addAttribute("articleContentList",
  // Content.findForManagedContent(article.getManagedContentId().getId()));
  ...
  // uiModel.addAttribute("articleList", Article.findEntries(firstResult,
  // sizeNo));
  ...
  // uiModel.addAttribute("articleCategoryList",
  // ArticleCategory.findForArticle(id));
  // uiModel.addAttribute("articleCommentList",
  // ArticleComment.findForArticle(id));
  ...
  // public String update(Article article, @RequestParam("abstractMedia")
  // MultipartFile abstractMedia,
  // BindingResult bindingResult, Model uiModel, HttpServletRequest
  // httpServletRequest) {
  // try {
  ...
  //
  // if (abstractMedia == null || abstractMedia.getBytes() == null ||
  // abstractMedia.getBytes().length == 0) {
  ...
  // }
  //
  // @RequestMapping(value = "/publish", method = RequestMethod.PUT, produces =
  // "text/html")
  // public String publish(Article article, BindingResult bindingResult, Model
  // uiModel,
  // HttpServletRequest httpServletRequest) {
  // if (bindingResult.hasErrors()) {
  // populateEditForm(uiModel, article);
  ...
  // addDateTimeFormatPatterns(uiModel);
  // uiModel.addAttribute("articleStatusList", ArticleStatus.findAll());
  // uiModel.addAttribute("availableCategoryList",
  // Category.findAvailableForArticle(article.getId()));
  // uiModel.addAttribute("articleCategoryList",
  // Category.findForArticle(article.getId()));
  // uiModel.addAttribute("managedContent", article.getManagedContentId());
  ...
  // public String showImage(@PathVariable("id") Integer id, HttpServletResponse
  // response, Model model) {
  // try {
  // Article article = Article.find(id);
  // if (article.getAbstractMedia() != null && article.getAbstractMedia().length
  // > 0) {
  ...
  // }
  //
  // @RequestMapping(value = "/category/{articleId}", method =
  // RequestMethod.POST, produces = "text/html")
  // public String createArticleCategory(@PathVariable("articleId") Integer
  // articleId, ArticleCategory articleCategory,
  // BindingResult bindingResult, Model uiModel, HttpServletRequest
  // httpServletRequest) {
  // if (bindingResult.hasErrors()) {
  // populateEditForm(uiModel, Article.find(articleId));
  // uiModel.addAttribute("articleCategoryList",
  // ArticleCategory.findForArticle(articleId));
  // uiModel.addAttribute("articleCommentList",
  // ArticleComment.findForArticle(articleId));
  // uiModel.addAttribute("articleCategory", new ArticleCategory());
  // uiModel.addAttribute("managedContent", new ManagedContent());
  // uiModel.addAttribute("articleComment", new ArticleComment());
  // uiModel.addAttribute("content", new Content());
  ...
  // uiModel.asMap().clear();
  // return "redirect:/admin/article/" +
  // encodeUrlPathSegment(articleId.toString(), httpServletRequest);
  // }
  //
  // @RequestMapping(value = "/comment/{articleId}", method =
  // RequestMethod.POST, produces = "text/html")
  // public String createArticleComment(@PathVariable("articleId") Integer
  // articleId, ArticleComment articleComment,
  // BindingResult bindingResult, Model uiModel, HttpServletRequest
  // httpServletRequest) {
  // if (bindingResult.hasErrors()) {
  // populateEditForm(uiModel, Article.find(articleId));
  ...
  // }
  //
  // @RequestMapping(value = "/category/{articleId}/{id}", method =
  // RequestMethod.DELETE, produces = "text/html")
  // public String deleteCategory(@PathVariable("articleId") Integer articleId,
  ...
  // }
  //
  // @RequestMapping(value = "/comment/{articleId}/{id}", method =
  // RequestMethod.DELETE, produces = "text/html")
  ...
  // }
  //
  // @RequestMapping(value = "/managed_content/{articleId}", method =
  // RequestMethod.PUT, produces = "text/html")
  // public String updateManagedContent(@PathVariable("articleId") Integer
  // articleId, ManagedContent managedContent,
  // BindingResult bindingResult, Model uiModel, HttpServletRequest
  // httpServletRequest) {
  // try {
  // if (bindingResult.hasErrors()) {
  ...
  // }
  //
  // @RequestMapping(value = "/content/{articleId}", method =
  // RequestMethod.POST, produces = "text/html")
  // public String createContent(@PathVariable("articleId") Integer articleId,
  // Content content,
  ...
  // }
  //
  // @RequestMapping(value = "/content/{articleId}/{id}", method =
  // RequestMethod.DELETE, produces = "text/html")
  // public String deleteContent(@PathVariable("articleId") Integer articleId,
  // @PathVariable("id") Integer id,
  // Model uiModel) {
