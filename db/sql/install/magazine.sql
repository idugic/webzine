...
ALTER TABLE NEWS_STATUS ADD CONSTRAINT NEWS_STAT_PK PRIMARY KEY (ID) ;
ALTER TABLE NEWS_STATUS ADD CONSTRAINT NEWS_STAT_UK_1 UNIQUE (CD) ;
...
ALTER TABLE NEWS ADD CONSTRAINT NEWS_NEWS_STAT_FK_1 FOREIGN KEY (STATUS_ID) REFERENCES NEWS_STATUS (ID);
