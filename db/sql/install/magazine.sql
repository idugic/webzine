...
CREATE TABLE ARTICLE (
  ...
  ABSTRACT_MEDIA              BLOB,
  ABSTRACT_MEDIA_CONTENT_TYPE VARCHAR (100),
...
ALTER TABLE ARTICLE ADD CONSTRAINT ARTI_USER_FK_2 FOREIGN KEY (UC) REFERENCES USERS (ID);
ALTER TABLE ARTICLE ADD CONSTRAINT ARTI_USER_FK_3 FOREIGN KEY (UM) REFERENCES USERS (ID);
