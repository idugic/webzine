...
ALTER TABLE CUSTOMER ADD CONSTRAINT ADVE_PK PRIMARY KEY (ID);
ALTER TABLE CUSTOMER ADD CONSTRAINT ADVE_ADDR_FK_1 FOREIGN KEY (ADDRESS_ID) REFERENCES ADDRESS (ID);
