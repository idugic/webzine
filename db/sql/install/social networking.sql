...
ALTER TABLE USER_ARTICLE ADD CONSTRAINT USER_ARTI_CK_1 CHECK (STATUS IN(1,2));
...
ALTER TABLE ARTICLE_COMMENT ADD CONSTRAINT ARTI_COMM_CK_1 CHECK (STATUS IN (1,100));
